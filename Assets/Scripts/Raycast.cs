...
public class Raycast : MonoBehaviour
{
    ...
    void InteractRayCast()
    {
        ...
        {        
            ...
            //Pickup Objects
            if (hitGameobject.tag == "Puzzle" && Input.GetKeyDown(KeyCode.E) && !carrying)
            {
            ...
            //Dropping each piece
            if (Input.GetKeyDown(KeyCode.E) && carrying && hitGameobject.name == "Slot 1")
            {
            ...
            if (Input.GetKeyDown(KeyCode.E) && carrying && hitGameobject.name == "Slot 2")
            {
                holding.gameObject.transform.gameObject.tag = "Puzzle";
                holding.gameObject.GetComponent<Rigidbody>().isKinematic = false;
                holding.GetComponent<Rigidbody>().useGravity = true;
            ...
            if (Input.GetKeyDown(KeyCode.E) && carrying && hitGameobject.name == "Slot 3")
            {
                holding.gameObject.transform.gameObject.tag = "Puzzle";
                holding.gameObject.GetComponent<Rigidbody>().isKinematic = false;
                holding.GetComponent<Rigidbody>().useGravity = true;
            ...
            if (Input.GetKeyDown(KeyCode.E) && carrying && hitGameobject.name == "Slot 4")
            {
                holding.gameObject.transform.gameObject.tag = "Puzzle";
                holding.gameObject.GetComponent<Rigidbody>().isKinematic = false;
                holding.GetComponent<Rigidbody>().useGravity = true;
            ...
            if (Input.GetKeyDown(KeyCode.E) && carrying && hitGameobject.name == "Slot 5")
            {
                holding.gameObject.transform.gameObject.tag = "Puzzle";
                holding.gameObject.GetComponent<Rigidbody>().isKinematic = false;
                holding.GetComponent<Rigidbody>().useGravity = true;
            ...
            if (Input.GetKeyDown(KeyCode.E) && carrying && hitGameobject.name == "Slot 6")
            {
                holding.gameObject.transform.gameObject.tag = "Puzzle";
                holding.gameObject.GetComponent<Rigidbody>().isKinematic = false;
                holding.GetComponent<Rigidbody>().useGravity = true;
            ...
            if (Input.GetKeyDown(KeyCode.E) && carrying && hitGameobject.name == "Slot 7")
            {
                holding.gameObject.transform.gameObject.tag = "Puzzle";
                holding.gameObject.GetComponent<Rigidbody>().isKinematic = false;
                holding.GetComponent<Rigidbody>().useGravity = true;
            ...
            if (Input.GetKeyDown(KeyCode.E) && carrying && hitGameobject.name == "Slot 8")
            {
                holding.gameObject.transform.gameObject.tag = "Puzzle";
                holding.gameObject.GetComponent<Rigidbody>().isKinematic = false;
                holding.GetComponent<Rigidbody>().useGravity = true;
            ...
            if (Input.GetKeyDown(KeyCode.E) && carrying && hitGameobject.name == "Slot 9")
            {
                holding.gameObject.transform.gameObject.tag = "Puzzle";
                holding.gameObject.GetComponent<Rigidbody>().isKinematic = false;
                holding.GetComponent<Rigidbody>().useGravity = true;
            ...
            if (Input.GetKeyDown(KeyCode.E) && carrying && hitGameobject.tag != "Slot")
            {
